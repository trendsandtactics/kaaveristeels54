...
export default function AboutHero() {
    return (
        <div className="w-full bg-white">
            {/* Hero Background Section - Updated to Burgundy Red */}
            <div className="w-full bg-gradient-to-r from-[#4A0404] via-[#800020] to-[#4A0404] pt-32 pb-20 relative overflow-hidden shadow-sm">
                {/* Background styling elements - Adjusted opacity for darker bg */}
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        <h2 className="font-body text-white/90 uppercase tracking-[0.2em] font-bold text-sm mb-4">About Us</h2>
                        <h1 className="font-heading text-5xl md:text-7xl text-white mb-8 leading-tight drop-shadow-lg">
                            ...
                            <span className="text-white font-extrabold text-4xl md:text-5xl block mt-2">TMT & STRUCTURAL</span>
                        </h1>
                        <p className="font-body text-white/80 text-lg md:text-xl leading-relaxed font-medium">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 relative z-10 bg-white">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20 mb-24">
                    <div className="w-full md:w-1/2 relative h-[400px] md:h-[500px] rounded-sm overflow-hidden group">
                        {/* Red tint overlay to match new theme */}
                        <div className="absolute inset-0 bg-[#800020]/10 z-10 mix-blend-multiply group-hover:bg-transparent transition-colors duration-500"></div>
                        <Image
                    ...
                    <div className="w-full md:w-1/2">
                        <h2 className="font-body text-[#800020] uppercase tracking-[0.2em] font-bold text-sm mb-4">Our Mission</h2>
                ...
                <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-20">
                    <div className="w-full md:w-1/2 relative h-[400px] md:h-[500px] rounded-sm overflow-hidden group">
                        {/* Red tint overlay to replace yellow */}
                        <div className="absolute inset-0 bg-[#800020]/10 z-10 mix-blend-multiply group-hover:bg-transparent transition-colors duration-500"></div>
                        <Image
                    ...
                    <div className="w-full md:w-1/2">
                        <h2 className="font-body text-[#800020] uppercase tracking-[0.2em] font-bold text-sm mb-4">Vision</h2>
                        <h3 className="font-heading text-4xl md:text-5xl text-black mb-6 leading-tight drop-shadow-sm font-extrabold">
